...
//    printf("startup head = %c", startUp->data);
//    printf("startup left child = %c\n", startUp->leftChild->data);
//    printf("???? = %c\n", startUp->leftChild->leftChild->leftChild->leftChild->leftChild->rightChild->data);
//    //printf("This should be a V = %c\n", startUp->leftChild->leftChild->leftChild->leftChild->leftChild->rightChild->rightChild->data);
//    printf("startup right child = %c\n", startUp->rightChild->data);
//    printf("%c", startUp->leftChild->leftChild->rightChild->rightChild->rightChild->rightChild->data);//this prints out an A when is should print out NULL
 ...
 * Author: guarr
 *
 * Created on May 29, 2017, 3:02 PM
 */
